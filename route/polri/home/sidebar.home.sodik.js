...
export function sidebar_home() {
  function _sdk_pages() {
    ...
    <div id="navbarLeftMenu" class="ly cpt cqa crh cuo cwj cyt">
      <button type="button" id="navbarLeft" class="absolute mt-4 right-0 sdk-ml-n40 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-collapse-toggle="navbarLeftMenu" aria-expanded="true">
